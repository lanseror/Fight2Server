...
<@s.form namespace="/task-reward" action="save" method="post" id="postFrom">
<table border="1" cellpadding="1" cellspacing="0">
    <@s.hidden name="taskId" />
    <@s.if test="taskReward!=null">
    <tr>
        <td>ID</td>
        <td><@s.textfield size="80" name="taskReward.id" readonly="true" /></td>
    </tr>
    </@s.if>
    <@s.else>
        <@s.hidden name="taskReward.id" value="0" />
    </@s.else>
     <tr height="150px">
        <td>
            <b>物品列表</b>
        ...
        <td align="center">
            ...
            <tbody id="itemBody">
                ...
                <@s.else>
                    <@s.iterator value="taskReward.rewardItems" status="status">
                     <tr>
